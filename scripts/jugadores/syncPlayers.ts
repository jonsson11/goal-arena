...
{nombre:"César Rodríguez", url:"https://en.wikipedia.org/wiki/C%C3%A9sar_Rodr%C3%ADguez_(footballer,_born_1920)"},
{nombre:"José Araquistáin", url:"https://en.wikipedia.org/wiki/Jos%C3%A9_Araquist%C3%A1in"}
  ];
