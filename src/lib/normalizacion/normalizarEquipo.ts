// src/lib/normalizacion/normalizarEquipo.ts
//
...
// scripts/equipos/sync-escudos-equipos.ts y
// scripts/jugadores/sync-top-scorers.ts. Se centraliza aquí porque,
// además de esos dos scripts, ahora también la usa `findOrCreateTeam`
// en scraping/wikipediaSync.ts -- que era el sitio donde en realidad
// nacían los equipos duplicados en Team: antes comparaba nombres con
// match EXACTO ("Atlético Madrid" !== "Club Atlético de Madrid" como
...
// contexto completo, y scripts/equipos/detectar-equipos-duplicados.ts /
// scripts/equipos/fusionar-equipos-duplicados.ts para arreglar los que
// ya existen.
